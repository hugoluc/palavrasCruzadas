...
soundfile = function () {
   ...
   */
  p5.SoundFile.prototype.play = function (_callBack, startTime, rate, amp, _cueStart, duration) {
    if (!this.output) {
    ...
    if (this.buffer) {
      ...
      if (this._paused) {
        this.bufferSourceNode.resume().start(time, this.pauseTime, duration);
        this._counterNode.resume().start(time, this.pauseTime, duration);
      } else {
